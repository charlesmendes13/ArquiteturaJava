...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<div class="container-fluid">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="/roupa/lista">Roupas</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="/calcado/lista">Calçados</a>
				</li>				
			</ul>
	...
	<div class="container mt-3">
		...
		<span class="badge rounded-pill bg-primary">Vendedor:
			...
			${qtdeProduto}</span> <span class="badge rounded-pill bg-success">Calçado:
			${qtdeCalcado}</span> <span class="badge rounded-pill bg-danger">Roupa:
			${qtdeRoupa}</span>
